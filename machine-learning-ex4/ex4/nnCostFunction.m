...
% %Removing bias for regularization terms
% Theta10=Theta1;
% Theta20=Theta2;
% Theta10(:,1)=0;
% Theta20(:,1)=0;

% J=sum(sum(-y_bin.*log(a3)-(1-y_bin).*log(1-a3)))/m+lambda/(2*m)*sum(sum(sum(Theta10.^2))+sum(sum(Theta20.^2)));
